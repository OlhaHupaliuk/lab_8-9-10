...
export const movies: Movie[] = [
  ...
  },
  {
    ...
    genre: 'Crime',
    sessions: [
      { id: 's8', time: '20:00', hall: 'Hall 2', availableSeats: 40 },
    ],
  },
  {
    id: 7,
    ...
    genre: 'Drama',
    sessions: [
      { id: 's9', time: '19:30', hall: 'Hall 1', availableSeats: 40 },
      { id: 's10', time: '20:30', hall: 'Hall 2', availableSeats: 40 },
    ],
  },
  {
    id: 8,
    img: 'src/assets/dark_knight.jpg',
    title: 'The Dark Knight',
    descr: 'Christopher Nolan\'s "The Dark Knight" is a masterpiece of the superhero genre, featuring Christian Bale as Batman and Heath Ledger in an unforgettable performance as the Joker. The film delves into themes of chaos, morality, and the fine line between heroism and villainy.',
    genre: 'Action',
    sessions: [
      { id: 's11', time: '19:45', hall: 'Hall 1', availableSeats: 40 },
      { id: 's12', time: '21:00', hall: 'Hall 2', availableSeats: 40 },
    ],
  },
];